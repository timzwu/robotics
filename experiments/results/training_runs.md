...
training loss. Passes = steps × batch ÷ frames in the dataset. Costs include Modal's CPU and RAM charges from Sept 12; earlier
rows are GPU-only. Smoke tests, fit trials and interrupted attempts are omitted.
...
| 2026-09-12 | pi05_so101_blocks_40000_ep0-49_100-149 | π0.5 fine-tune, matched to SmolVLA (24 passes) | same 100 pair episodes | 40,000 × 32 | 24 | H100 | 9.9 h for steps 10k→40k (1.18 s/step); ~13.2 h of H100 in total across both attempts | ≈$41 this leg (≈$65 total incl. attempt 1; GPU-only) | 0.049 |
| 2026-09-13 | pi05full_so101_blocks_30000_ep0-49_100-149 | π0.5 fine-tune, PI's recipe: whole model trains (no freeze flags), LR 2.5e-5 cosine to 30k, bf16, grad checkpointing | same 100 pair episodes | 30,000 × 32 (global; 8 per card) = 18 passes | 18 | 4 × H100 | 362 min (1.39–1.42 step/s; data loading ~0.5 s/step early, 0.008 s late) | ≈$100 (estimate said 3.8 h / $65; ran 6 h) | 0.012 |
| 2026-09-15 | smolvla_so101_blocks_sim_20000 | SmolVLA fine-tune from `lerobot/smolvla_base`, condition C of the sim experiment | `so101_blocks_sim`: 100 scripted sim episodes, red→left, blue→right (36,771 frames) | 20,000 × 64 | 35 | L40S | 192 min | ≈$7.50 ($2.33/h incl. CPU+RAM) | 0.003 |
...
| 2026-09-16 | smolvla_so101_blocks_sim_v2_20000_ep0-99 | SmolVLA fine-tune from `lerobot/smolvla_base`, condition C2: sim v2 only | `so101_blocks_sim_v2` episodes 0–99: 100 scripted sim episodes of the sim v2 (41,184 frames) | 20,000 × 64 | 31 | L40S | 193 min | ≈$7.50 | 0.006 |
