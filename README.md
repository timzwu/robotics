...
## 2 · Making sense of robotics models

![Robot learning models placed on five axes, 2022 to 2026](posts/robotics-model-timeline.gif)

Post #2 proposes five axes for understanding the design decisions behind a robot learning model:

- **Learning signal:** how it learns (imitation, rewards, prediction)
- **Architecture:** model structure and inherited knowledge
- **Data:** what it learns from
- **Instruction:** how a task is communicated at run time
- **Execution:** how predicted actions unfold into movement

Every model can likely improve with more data and more compute, but sometimes it is the structural design choices along
these axes that unlock the largest improvements. The animation plays the key papers and company releases from 2022 to
2026 in order, each tagged with its choices on the five axes, with lines between releases that share a choice.
Interactive version: [timwu2.com/robotics-timeline](https://www.timwu2.com/robotics-timeline).
